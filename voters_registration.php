...
//}else{
	...
	if (isset($_POST['sub'])){
		...
		if($nic==NULL || $fname==NULL || $lname==NULL || $add_l1==NULL || $add_l2==NULL || $add_l3==NULL || $age==NULL || $distric==NULL || $p_division==NULL || $province==NULL || $p_station==NULL){
			$msg1="You can't leave this fields are empty";
		}else if($nic_s=="true" || $fname_s=="true" || $lname_s=="true" || $add_l1_s=="true" || $add_l2_s=="true" || $add_l3_s=="true" || $age_s=="true" || $distric_s=="true" || $p_division_s=="true" || $province_s=="true"){
	...
	$insert=mysql_query("INSERT INTO voters_details VALUES('$nic','$fname','$lname','$add_l1','$add_l2','$add_l3','$age','$province','$distric','$p_division','$p_station','Not_Ok')");
...
<table width="550" border="0" align="center">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF"><h3><strong>Voter's Registration</strong></h3></td>
  </tr>
  <tr>
...
<option value="Western">Western
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF"><label><select name="p_station" id="p_stationabc" size=1 onChange="gif3Validate(this.value)"  onBlur="pstationValidate(this.value)">
      <option>Select your polling Station..
