...
//}else{
	...
	if (isset($_POST['sub'])){
		...
		if($nic==NULL || $fname==NULL || $lname==NULL || $add_l1==NULL || $add_l2==NULL || $add_l3==NULL || $age==NULL || $distric==NULL || $p_division==NULL || $province==NULL || $email==NULL || $e_party==NULL){
			$msg1="You can't leave this fields are empty";
		}else if($nic_s=="true" || $fname_s=="true" || $lname_s=="true" || $add_l1_s=="true" || $add_l2_s=="true" || $add_l3_s=="true" || $age_s=="true" || $distric_s=="true" || $province_s=="true" || $mail_s=="true"){
	...
	$insert=mysql_query("INSERT INTO candidates_details VALUES('','$nic','$fname','$lname','$add_l1','$add_l2','$add_l3','$age','$email','$province','$distric','$e_party')");
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("party").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","Validaters/party_validator.php?q="+str,true);
xmlhttp.send();
}
...
<table width="550" border="0" align="center">
  ...
  <tr>
    <td colspan="4" bgcolor="#FFFFFF"><h3><strong>Candidate Registration</strong></h3></td>
  </tr>
  <tr>
...
<option value="Western">Western
  ...
  <tr>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">Election Party</td>
    <td colspan="2" bgcolor="#FFFFFF"><label>
      <select name="party" id="party2" size=1 onChange="gif3Validate(this.value)"  onBlur="partyValidate(this.value)">
        <option>Select your Election party..</option>
        <option value="United National Party">United National Party</option>
        <option value="United Peoples Freedom Alliance">United Peoples Freedom Alliance</option>
        <option value="Peoples Liberation Front">Peoples Liberation Front</option>
        <option value="Jathika Hela Urumaya">Jathika Hela Urumaya</option>
        <option value="New Democratic Front">New Democratic Front</option>
        <option value="Sri Lanka Muslim Congress">Sri Lanka Muslim Congress</option>
        
      </select><span id="party"></span></label></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
